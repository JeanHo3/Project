...
public class Fenetre extends JFrame {
	...
	final Collection<File> all = new ArrayList<File>();
		...
		private void showComplete() {
			...
			textComplet.append("Nom du synoptique;Nom du symbole;Erreur;Tag Associé;ShareKeyword;CustomData de référence;CustomData du synoptique;Position X;Position Y;API Associé;CHM_ACQ Associé;CHM_ALM Associé");
			for(int i=0;i<this.synoptiques.size();i++) {
	        ...
	        try {
	            FileWriter fileWriter = new FileWriter("D:\\Users\\Jean.HOURMANT\\Desktop\\" + fileName, true);
