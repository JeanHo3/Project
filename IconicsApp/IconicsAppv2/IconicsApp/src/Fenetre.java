...
public class Fenetre extends JFrame {
	...
	public void initialize1() {
		...
		pansyno.setMaximumSize(new Dimension(800,30));
		pansyno.add(syno);
		
		pansymb.setLayout(new BoxLayout(pansymb, BoxLayout.LINE_AXIS));
		pansymb.setMaximumSize(new Dimension(800,30));
		pansymb.add(symb);
	...
	private void getProperties() {
		...
		panprop.setMaximumSize(new Dimension(600,proprietes.size()*30));
		panprop.setLayout(new BoxLayout(panprop,BoxLayout.PAGE_AXIS));
		panprop1.setMaximumSize(new Dimension(200,proprietes.size()*30));
